...
file_path1 = '/content/drive/MyDrive/research/cpu-gpu-nvme_measuring_files/wait_time_cpu_gpu_nvme_param16_falcon_10_b_mine.csv'
df1 = pd.read_csv(file_path1, usecols=[0, 1], skiprows=range(1, 727), nrows=726)
...
file_path2 = '/content/drive/MyDrive/research/cpu-gpu-nvme_measuring_files/wait_time_cpu_gpu_nvme_param16_falcon_10_b_deepspeed_bs1.csv'
...
plt.text(0.0002, 0.85, f'{percentage1:.1f}% below 0.03 ms',
         color='#00b4d8', fontsize=10, bbox=dict(facecolor='white', alpha=0.8, edgecolor='none'))
plt.text(0.0002, 0.55, f'{percentage2:.1f}% below 0.03 ms',
...
plt.tight_layout()
plt.savefig('wait_time_cpu_gpu_nvme_param16_falcon_10_b_both.pdf')
plt.show()