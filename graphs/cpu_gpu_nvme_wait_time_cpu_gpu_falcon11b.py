...
file_path1 = '/content/drive/MyDrive/research/cpu-gpu-nvme_measuring_files/wait_time_cpu_gpu_nvme_param16_falcon_11_b_mine.csv'
df1 = pd.read_csv(file_path1, usecols=[0, 1], skiprows=range(1, 729), nrows=728)
...
file_path2 = '/content/drive/MyDrive/research/cpu-gpu-nvme_measuring_files/wait_time_cpu_gpu_nvme_param16_falcon_11_b_deepspeed_bs1.csv'
...
plt.tight_layout()
plt.savefig('wait_time_cpu_gpu_nvme_param16_falcon_11_b_both.pdf')
plt.show()