...
class AsyncTensorSwapper(object):
    ...
    def _wait_for_swap_complete(self):
        ...
        #value = self.aio_handle.wait()
        # with open("/home/sabiha/deepspeed_example/deepspeed_fp32_reads_writes.txt", 'a') as file:
        #     file.write(f"/deepspeed/runtime/zero/stage3.py#LN479 inside def _wait_for_swap_complete reading aio_handle value {value} self.num_pending_swaps {self.num_pending_swaps} \n")
        #assert value == self.num_pending_swaps
