...
file_path1 = '/content/drive/MyDrive/research/wait_time_cpu_gpu_falcon_7_b_mine.csv'
df1 = pd.read_csv(file_path1, usecols=[0, 1], skiprows=range(1, 394), nrows=392)
...
file_path2 = '/content/drive/MyDrive/research/wait_time_cpu_gpu_falcon_7_b_deepspeed_bs1.csv'
df2 = pd.read_csv(file_path2, usecols=[0, 1], skiprows=range(1, 394), nrows=392)
...
plt.tight_layout()
plt.savefig('wait_time_cpu_gpu_falcon_7_b_both.pdf')
